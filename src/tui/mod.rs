...
impl TuiApp {
    ...
    pub async fn run(
        ...
        execute!(stdout, EnterAlternateScreen, cursor::SetCursorStyle::BlinkingBar)?;
        ...
        disable_raw_mode()?;
        execute!(terminal.backend_mut(), LeaveAlternateScreen, cursor::SetCursorStyle::DefaultUserShape)?;
        Ok(())
    }
